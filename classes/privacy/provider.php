...
/**
 * Privacy Subsystem implementation for theme_coastguard_var_03.
 *
...
namespace theme_coastguard_var_03\privacy;
...
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropenindexpref)) {
            $preferencestring = get_string('privacy:drawerindexclosed', 'theme_coastguard_var_03');
            if ($draweropenindexpref == 1) {
                $preferencestring = get_string('privacy:drawerindexopen', 'theme_coastguard_var_03');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_coastguard_var_03',
        ...
        if (isset($draweropenblockpref)) {
            $preferencestring = get_string('privacy:drawerblockclosed', 'theme_coastguard_var_03');
            if ($draweropenblockpref == 1) {
                $preferencestring = get_string('privacy:drawerblockopen', 'theme_coastguard_var_03');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_coastguard_var_03',
