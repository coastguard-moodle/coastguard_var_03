 ...
 *
 * @module     theme_coastguard_var_03/drawers
 ...
 * {@link module:theme_coastguard_var_03/drawers#eventTypes eventTypes} object.
 *
 * @example <caption>Standard usage</caption>
 *
 * // The module just needs to be included to add drawer support.
 * import 'theme_coastguard_var_03/drawers';
 *
 * @example <caption>Manually open or close any drawer</caption>
 *
 * import Drawers from 'theme_coastguard_var_03/drawers';
 *
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_coastguard_var_03/drawers:show}
     * @property {String} drawerShown See {@link event:theme_coastguard_var_03/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_coastguard_var_03/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_coastguard_var_03/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_coastguard_var_03/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_coastguard_var_03/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_coastguard_var_03/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_coastguard_var_03/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_coastguard_var_03/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_coastguard_var_03/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_coastguard_var_03/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_coastguard_var_03/drawers:hidden',
    };
     ...
     * @returns {module:theme_coastguard_var_03/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_coastguard_var_03/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_coastguard_var_03/drawers:close');
     ...
     *
     * @param {module:theme_coastguard_var_03/drawers} comparisonInstance
     */
